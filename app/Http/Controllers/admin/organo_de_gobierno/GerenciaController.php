...
class GerenciaController extends Controller
{
    ...
    {
        $directiva=SubOrganosGobierno::where('nombre','Gerencia')->first();
        return view('admin.organos_de_gobierno.ejecucion.gerencia.index',compact('directiva'));
    }
    ...
    return view('admin.organos_de_gobierno.ejecucion.gerencia.create', compact('cargos'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cargo=Cargo::where('cargo','Gerente')->first();
    ...
    public function edit($id)
    {
        ...
        $cargos=Cargo::where('activo','1')->where('borrado',0)->pluck('cargo','id');
        return view('admin.organos_de_gobierno.ejecucion.gerencia.edit', compact('funcionario','cargos'));
    }
