...
class ProductivasController extends Controller
{
    ...
    {
        $directiva=SubOrganosGobierno::where('nombre','Actividades Productivas')->first();
        return view('admin.organos_de_gobierno.linea.actividades.productivas.index',compact('directiva'));
    }
    ...
    {
        return view('admin.organos_de_gobierno.linea.actividades.productivas.createProd');
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        if ($subOrgano instanceof Model) {
            toastr()->success('Actividad Productiva registrada correctamente!');
            return redirect()->route('productiva.index');
        }
    ...
    public function edit($id)
    {
        ...
        return view('admin.organos_de_gobierno.linea.actividades.productivas.editProd', compact('subOrgano'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($subOrgano==1) {
            toastr()->success('Actividad Productiva editada correctamente!');
            return redirect()->route('productiva.index');
        }
        toastr()->error('Ha ocurrido un error, por favor inténtelo nuevamente.');
        return back();
    ...
    public function destroy($id)
    {
        ...
        if ($subOrgano==1) {
            toastr()->info('Actividad Productiva eliminada correctamente!');
            return redirect()->route('productiva.index');
        }
        toastr()->error('Ha ocurrido un error, por favor inténtelo nuevamente.');
        return back();
