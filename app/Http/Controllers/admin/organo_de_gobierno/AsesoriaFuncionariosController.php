...
class AsesoriaFuncionariosController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.organos_de_gobierno.apoyo_asesoria.asesoria.create', compact('cargos'));
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        $directiva=SubOrganosGobierno::where('nombre','Órganos de Asesoría')->first();
    ...
    public function edit($id)
    {
        ...
        $cargos=Cargo::where('activo','1')->where('borrado',0)->pluck('cargo','id');
        return view('admin.organos_de_gobierno.apoyo_asesoria.asesoria.edit', compact('funcionario','cargos'));
    }
