...
class ComiteFuncionariosController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.organos_de_gobierno.apoyo_asesoria.comites_especializados.create', compact('cargos'));
    }
    /**
    ...
    public function edit($id)
    {
        ...
        $cargos=Cargo::where('activo','1')->where('borrado',0)->pluck('cargo','id');
        return view('admin.organos_de_gobierno.apoyo_asesoria.comites_especializados.edit', compact('funcionario','cargos'));
    }
