...
class EmpresarialesController extends Controller
{
    ...
    {
        return view('admin.organos_de_gobierno.linea.actividades.empresariales.createEmp');
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        if ($subOrgano instanceof Model) {
            toastr()->success('Actividad Empresarial registrada correctamente!');
    ...
    public function edit($id)
    {
        ...
        return view('admin.organos_de_gobierno.linea.actividades.empresariales.editEmp', compact('subOrgano'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($subOrgano==1) {
            toastr()->success('Actividad Empresarial editada correctamente!');
            return redirect()->route('empresarial.index');
        }
        toastr()->error('Ha ocurrido un error, por favor inténtelo nuevamente.');
        return back();
    ...
    public function destroy($id)
    {
        ...
        if ($subOrgano==1) {
            toastr()->info('Actividad Empresarial eliminada correctamente!');
            return redirect()->route('empresarial.index');
        }
        toastr()->error('Ha ocurrido un error, por favor inténtelo nuevamente.');
        return back();
