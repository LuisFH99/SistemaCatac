...
class ProductivasFuncionariosController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.organos_de_gobierno.linea.actividades.productivas.create', compact('cargos'));
    }
    /**
    ...
    public function edit($id)
    {
        ...
        $cargos=Cargo::where('activo','1')->where('borrado',0)->pluck('cargo','id');
        return view('admin.organos_de_gobierno.linea.actividades.productivas.edit', compact('funcionario','cargos'));
    }
