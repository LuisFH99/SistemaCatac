...
class ComiteController extends Controller
{
    ...
    {
        $directiva=SubOrganosGobierno::where('nombre','Comités Especializados')->first();
        return view('admin.organos_de_gobierno.apoyo_asesoria.comites_especializados.index',compact('directiva'));
    }
    ...
    {
        return view('admin.organos_de_gobierno.apoyo_asesoria.comites_especializados.createComite');
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        if ($subOrgano instanceof Model) {
            toastr()->success('Comité Especializado registrado correctamente!');
    ...
    public function edit($id)
    {
        ...
        return view('admin.organos_de_gobierno.apoyo_asesoria.comites_especializados.editComite', compact('subOrgano'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($subOrgano==1) {
            toastr()->success('Comité Especializado editado correctamente!');
            return redirect()->route('comite.index');
        }
        toastr()->error('Ha ocurrido un error, por favor inténtelo nuevamente.');
        return back();
    ...
    public function destroy($id)
    {
        ...
        if ($subOrgano==1) {
            toastr()->info('Comité Especializado eliminado correctamente!');
            return redirect()->route('comite.index');
        }
        toastr()->error('Ha ocurrido un error, por favor inténtelo nuevamente.');
        return back();
