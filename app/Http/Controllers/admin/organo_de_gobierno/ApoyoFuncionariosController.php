...
class ApoyoFuncionariosController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.organos_de_gobierno.apoyo_asesoria.apoyo.create', compact('cargos'));
    }
    /**
    ...
    public function edit($id)
    {
        ...
        $cargos=Cargo::where('activo','1')->where('borrado',0)->pluck('cargo','id');
        return view('admin.organos_de_gobierno.apoyo_asesoria.apoyo.edit', compact('funcionario','cargos'));
    }
    ...
    public function updateApoyo(Request $request, $id)
    {
        $request->validate([
