    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    {!! Form::model($instrumento, ['route' => ['instrumento_de_gestion.update', $instrumento->id], 'method' => 'PUT','novalidate', 'files' => true]) !!}
                        @csrf
                        @include('admin.instrumento_de_gestion.partials.form-edit')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
