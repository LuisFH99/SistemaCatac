...
@section('title', 'Registrar Modificatoria')

@section('content_header')
    <h1>Registrar Modificatoria</h1>
@stop
        ...
        <div class="container-fluid">
            <div class="card mt-4">
                <div class="card-header">
                    Registrar Modificatoria
                </div>
                <div class="card-body">
                    {!! Form::open(['route' => 'instrumento_de_gestion.store','class'=>'needs-validation','novalidate', 'files' => true]) !!}
                        @csrf
                        @include('admin.instrumento_de_gestion.partials.form-create')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
