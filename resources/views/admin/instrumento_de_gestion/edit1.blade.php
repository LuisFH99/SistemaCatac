...
@section('title', 'Editar Modificatoria')

@section('content_header')
    <h1>Editar Modificatoria</h1>
@stop
        ...
        <div class="container-fluid">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">
                    <a href="{{ route('instrumento_de_gestion.index') }}">
        ...
        <div class="container-fluid">
            <div class="card mt-4">
                <div class="card-header">
                    Editar Modificatoria
                </div>
                <div class="card-body">
                    {!! Form::model($modificatoria, ['route' => ['instrumento_de_gestion.update', $modificatoria->id], 'method' => 'PUT','novalidate', 'files' => true]) !!}
                        @csrf
                        @include('admin.instrumento_de_gestion.partials.form-edit1')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
