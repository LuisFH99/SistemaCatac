            ...
            <div id="accordion">
                <div class="card ">
                    ...
                    <div id="collapseDescripcion" class="collapse" data-parent="#accordion">
                        <div class="card-body">
                            {!! Form::model($asamblea, ['route' => ['asamblea_general.updateAsamblea', $asamblea->id], 'method' => 'PUT']) !!}
                            <div class="row">
                                    
                                    <div class="col-md-11">
                                        <div class="col-md-10">
                                            <textarea name="descripcion" id="descripcion" cols="20" rows="5" class="form-control" disabled required>{{ $asamblea->descripcion }}</textarea>
                                            @error('descripcion')
                ...
                <div class="card ">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-9">
                                <h3 class="card-title font-weight-bold text-uppercase mt-1">Lista de Asambleistas</h3>
                            </div>
            
                            <div class="col-3 d-flex justify-content-end">
                                <a href="{{ route('asamblea_general.create') }}" class="btn btn-success float-right">
                        ...
                        <div class="card mt-4">
                            @livewire('admin.organo-de-gobierno.listar-asamblea')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-button', function() {
                ...
                Swal.fire({
                title: '¿Estás seguro?',
                text: "¡Se eliminará al comunero y todo registro relacionado, esta operación no se podrá revertir!",
                type: 'warning',
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{ url('admin/organos_de_gobierno/direccion/asamblea_general') }}" + '/' + id,
                        type: "POST",
        ...
        function habilitar(ids,aux) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/admin/organos_de_gobierno/direccion/asamblea_general/habilitar',
                        method: 'POST',
                        data: {
