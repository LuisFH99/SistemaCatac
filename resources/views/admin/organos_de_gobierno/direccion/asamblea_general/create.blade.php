...
@section('title', 'Registrar Asambleista')

@section('content_header')
    <h1>Registrar Comunero</h1>
@stop
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    {!! Form::open(['route' => 'asamblea_general.store','class'=>'needs-validation','novalidate', 'files' => true]) !!}
                        @csrf
                        @include('admin.organos_de_gobierno.direccion.asamblea_general.partials.form-create')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
