...
@section('title', 'Registrar Gerente')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    {!! Form::open(['route' => 'gerencia.store','class'=>'needs-validation','novalidate', 'files' => true]) !!}
                        @csrf
                        @include('admin.organos_de_gobierno.ejecucion.gerencia.partials.form-create')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
