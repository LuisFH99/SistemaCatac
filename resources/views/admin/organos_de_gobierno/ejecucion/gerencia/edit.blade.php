    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    {!! Form::model($funcionario, ['route' => ['gerencia.update', $funcionario->id], 'method' => 'PUT','novalidate', 'files' => true]) !!}
                        @csrf
                        @include('admin.organos_de_gobierno.ejecucion.gerencia.partials.form-edit')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
