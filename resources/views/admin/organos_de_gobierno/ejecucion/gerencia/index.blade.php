                ...
                <div class="card ">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-3 d-flex justify-content-end">
                                <a href="{{ route('gerencia.create') }}" class="btn btn-success float-right">
                        ...
                        <div class="card mt-4">
                            @livewire('admin.organo-de-gobierno.listar-gerencia',['aux'=>2,'ruta'=>'gerencia'])
                        </div>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-button', function() {
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{ url('admin/organos_de_gobierno/ejecucion/gerencia') }}" + '/' + id,
                        type: "POST",
        ...
        function habilitar(ids,aux) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/admin/organos_de_gobierno/ejecucion/gerencia/habilitar',
                        method: 'POST',
                        data: {
