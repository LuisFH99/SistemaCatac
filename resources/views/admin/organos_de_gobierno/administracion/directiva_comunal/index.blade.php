...
@section('title', 'Directiva Comunal')

@section('content_header')
    <h1>Directiva Comunal</h1>
@stop
            ...
            <div id="accordion">
                ...
                <div class="card ">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-9">
                                <h3 class="card-title font-weight-bold text-uppercase mt-1">Lista de los Funcionarios</h3>
                            </div>
            
                            <div class="col-3 d-flex justify-content-end">
                                <a href="{{ route('directiva_comunal.create') }}" class="btn btn-success float-right">
                        ...
                        <div class="card mt-4">
                            @livewire('admin.organo-de-gobierno.listar-directiva')
                        </div>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-button', function() {
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{ url('admin/organos_de_gobierno/administracion/directiva_comunal') }}" + '/' + id,
                        type: "POST",
        ...
        function habilitar(ids,aux) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/admin/organos_de_gobierno/administracion/directiva_comunal/habilitar',
                        method: 'POST',
                        data: {
