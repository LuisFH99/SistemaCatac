        ...
        <div class="container-fluid">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">
                    <a href="{{ route('directiva_comunal.index') }}">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    {!! Form::model($funcionario, ['route' => ['directiva_comunal.update', $funcionario->id], 'method' => 'PUT','novalidate', 'files' => true]) !!}
                        @csrf
                        @include('admin.organos_de_gobierno.administracion.directiva_comunal.partials.form-edit')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
