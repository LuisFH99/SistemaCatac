    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    {!! Form::open(['route' => 'directiva_comunal.store','class'=>'needs-validation','novalidate', 'files' => true]) !!}
                        @csrf
                        @include('admin.organos_de_gobierno.administracion.directiva_comunal.partials.form-create')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
