...
@section('title', 'Registrar Actividad Productiva')

@section('content_header')
    <h1>Registrar Actividad Productiva</h1>
@stop
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    {!! Form::open(['route' => 'productiva.store','class'=>'needs-validation']) !!}
                        @csrf
                        @include('admin.organos_de_gobierno.linea.actividades.productivas.partials.form-createProd')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
