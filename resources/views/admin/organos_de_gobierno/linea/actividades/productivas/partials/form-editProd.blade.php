<div class="form-row">
	<div class="col-md-3 col-sm-6 my-3">
		<div class="form-group">
			...
			{{ Form::text('nombre', $subOrgano->nombre, array_merge(['class' => 'form-control'], 
	...
	<div class="col-md-4 col-sm-8 my-3">
		<div class="form-group">
			...
			{{ Form::textarea('descripcion', $subOrgano->descripcion, array_merge(['class' => 'form-control'], 
...
<div class="form-group">
    ...
    <a href="{{ route('productiva.index') }}" class="btn btn-danger">
