...
@section('title', 'Editar Actividad Productiva')

@section('content_header')
    <h1>Editar Actividad Productiva</h1>
@stop
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    {!! Form::model($subOrgano, ['route' => ['productiva.update', $subOrgano->id], 'method' => 'PUT']) !!}
                        @csrf
                        @include('admin.organos_de_gobierno.linea.actividades.productivas.partials.form-editProd')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
