...
@section('title', 'Actividades Productivas')

@section('content_header')
    <h1>Actividades Productivas</h1>
@stop
            ...
            <div id="accordion">
                ...
                <div class="card ">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-9">
                                <h3 class="card-title font-weight-bold text-uppercase mt-1">Actividades Productivas</h3>
                            </div>
                            <div class="col-3 d-flex justify-content-end">
                    ...
                    <div id="collapseApoyo" class="collapse" data-parent="#accordion">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-3 d-flex justify-content-end">
                                    <a href="{{ route('productiva.create') }}" class="btn btn-success float-right">
                            ...
                            <div class="card mt-4">
                                @livewire('admin.organo-de-gobierno.listar-apoyo',['aux'=>7,'ruta'=>'productiva'])
                            </div>
                        </div>
                    </div>
                </div>  <br>
                    ...
                    <div id="collapseFuncionarios" class="collapse" data-parent="#accordion">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-3 d-flex justify-content-end">
                                    <a href="{{ route('productivas.create') }}" class="btn btn-success float-right">
                                        <i class="fas fa-fw fa-save"></i>
                                        Registrar
                                    </a>
                                </div><hr>
                            ...
                            <div class="card mt-4">
                                @livewire('admin.organo-de-gobierno.listar-gerencia',['aux'=>7,'ruta'=>'productivas'])
                            </div>
                        </div>
                    </div>
                </div>  <br>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-button', function() {
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{ url('admin/organos_de_gobierno/linea/actividades/productivas') }}" + '/' + id,
                        type: "POST",
            ...
            $(document).on('click', '.delete-button1', function() {
                ...
                Swal.fire({
                title: '¿Estás seguro?',
                text: "¡Se eliminará a la Actividad Productiva y todo registro relacionado, esta operación no se podrá revertir!",
                type: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.value) {
                    ...
                    let id = $(element).attr('id');
                    $.ajax({
                        url: "{{ url('admin/organos_de_gobierno/linea/actividades/productiva') }}" + '/' + id,
                        type: "POST",
                        data: {'_method': 'DELETE', '_token': csrf_token},
                        success: function(data) {
                            $(document).Toasts('create', {
        ...
        function habilitar(ids,aux) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/admin/organos_de_gobierno/linea/actividades/productivas/habilitar',
                        method: 'POST',
                        data: {
