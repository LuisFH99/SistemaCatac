...
@section('title', 'Editar Actividad Empresarial')

@section('content_header')
    <h1>Editar Actividad Empresarial</h1>
@stop
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    {!! Form::model($subOrgano, ['route' => ['empresarial.update', $subOrgano->id], 'method' => 'PUT']) !!}
                        @csrf
                        @include('admin.organos_de_gobierno.linea.actividades.empresariales.partials.form-editEmp')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
