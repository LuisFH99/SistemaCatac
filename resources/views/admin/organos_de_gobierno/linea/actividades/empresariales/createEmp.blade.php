...
@section('title', 'Registrar Actividad Empresarial')

@section('content_header')
    <h1>Registrar Actividad Empresarial</h1>
@stop
        ...
        <div class="container-fluid">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">
                    <a href="{{ route('empresarial.index') }}">
                        <i class="fas fa-fw fa-arrow-left"></i>
                        Lista de Actividades Empresariales
                    </a>
                </li>
        ...
        <div class="container-fluid">
            <div class="card mt-4">
                <div class="card-header">
                    Registrar Actividad Empresarial
                </div>
                <div class="card-body">
                    {!! Form::open(['route' => 'empresarial.store','class'=>'needs-validation']) !!}
                        @csrf
                        @include('admin.organos_de_gobierno.linea.actividades.empresariales.partials.form-createEmp')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
