...
@section('title', 'Registrar Órgano de Apoyo')

@section('content_header')
    <h1>Registrar Órgano de Apoyo</h1>
@stop
        ...
        <div class="container-fluid">
            <div class="card mt-4">
                <div class="card-header">
                    Registrar Órgano de Apoyo
                </div>
                <div class="card-body">
                    {!! Form::open(['route' => 'apoyo.store','class'=>'needs-validation']) !!}
                        @csrf
                        @include('admin.organos_de_gobierno.apoyo_asesoria.apoyo.partials.form-createApoyo')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
