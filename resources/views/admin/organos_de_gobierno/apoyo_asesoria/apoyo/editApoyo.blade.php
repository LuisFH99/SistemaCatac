...
@section('title', 'Editar Órgano de Apoyo')

@section('content_header')
    <h1>Editar Órgano de Apoyo</h1>
@stop
        ...
        <div class="container-fluid">
            <div class="card mt-4">
                <div class="card-header">
                    Editar Órgano de Apoyo
                </div>
                <div class="card-body">
                    {!! Form::model($subOrgano, ['route' => ['apoyo.update', $subOrgano->id], 'method' => 'PUT']) !!}
                        @csrf
                        @include('admin.organos_de_gobierno.apoyo_asesoria.apoyo.partials.form-editApoyo')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
