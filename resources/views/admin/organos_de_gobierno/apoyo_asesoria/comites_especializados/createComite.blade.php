...
@section('title', 'Registrar Comité Especializado')

@section('content_header')
    <h1>Registrar Comité Especializado</h1>
@stop
        ...
        <div class="container-fluid">
            <div class="card mt-4">
                <div class="card-header">
                    Registrar Comité Especializado
                </div>
                <div class="card-body">
                    {!! Form::open(['route' => 'comite.store','class'=>'needs-validation']) !!}
                        @csrf
                        @include('admin.organos_de_gobierno.apoyo_asesoria.comites_especializados.partials.form-createComite')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
