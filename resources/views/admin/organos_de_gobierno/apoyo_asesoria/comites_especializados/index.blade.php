...
@section('title', 'Comités Especializados')

@section('content_header')
    <h1>Comités Especializados</h1>
@stop
            ...
            <div id="accordion">
                ...
                <div class="card ">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-9">
                                <h3 class="card-title font-weight-bold text-uppercase mt-1">Comités Especializados</h3>
                            </div>
                            <div class="col-3 d-flex justify-content-end">
                    ...
                    <div id="collapseApoyo" class="collapse" data-parent="#accordion">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-3 d-flex justify-content-end">
                                    <a href="{{ route('comite.create') }}" class="btn btn-success float-right">
                            ...
                            <div class="card mt-4">
                                @livewire('admin.organo-de-gobierno.listar-apoyo',['aux'=>5,'ruta'=>'comite'])
                            </div>
                        </div>
                    </div>
                </div>  <br>
                    ...
                    <div id="collapseFuncionarios" class="collapse" data-parent="#accordion">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-3 d-flex justify-content-end">
                                    <a href="{{ route('comites.create') }}" class="btn btn-success float-right">
                                        <i class="fas fa-fw fa-save"></i>
                                        Registrar
                                    </a>
                                </div><hr>
                            ...
                            <div class="card mt-4">
                                @livewire('admin.organo-de-gobierno.listar-gerencia',['aux'=>5,'ruta'=>'comites'])
                            </div>
                        </div>
                    </div>
                </div>  <br>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-button', function() {
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{ url('admin/organos_de_gobierno/apoyo_asesoria/comites') }}" + '/' + id,
                        type: "POST",
            ...
            $(document).on('click', '.delete-button1', function() {
                ...
                if (result.value) {
                    ...
                    let id = $(element).attr('id');
                    $.ajax({
                        url: "{{ url('admin/organos_de_gobierno/apoyo_asesoria/comite') }}" + '/' + id,
                        type: "POST",
                        data: {'_method': 'DELETE', '_token': csrf_token},
                        success: function(data) {
                            $(document).Toasts('create', {
        ...
        function habilitar(ids,aux) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/admin/organos_de_gobierno/apoyo_asesoria/comites/habilitar',
                        method: 'POST',
                        data: {
