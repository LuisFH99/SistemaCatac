...
@section('title', 'Editar Comité Especializado')

@section('content_header')
    <h1>Editar Comité Especializado</h1>
@stop
            ...
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">
                    <a href="{{ route('comite.index') }}">
                        ...
                        Lista de Comités Especializados
                    </a>
                </li>
        ...
        <div class="container-fluid">
            <div class="card mt-4">
                <div class="card-header">
                    Editar Comité Especializado
                </div>
                <div class="card-body">
                    {!! Form::model($subOrgano, ['route' => ['comite.update', $subOrgano->id], 'method' => 'PUT']) !!}
                        @csrf
                        @include('admin.organos_de_gobierno.apoyo_asesoria.comites_especializados.partials.form-editComite')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
