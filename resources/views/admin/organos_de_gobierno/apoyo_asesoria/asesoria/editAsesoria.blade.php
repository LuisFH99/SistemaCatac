...
@section('title', 'Editar Órgano de Asesoria')

@section('content_header')
    <h1>Editar Órgano de Asesoria</h1>
@stop
        ...
        <div class="container-fluid">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">
                    <a href="{{ route('asesoria.index') }}">
                        <i class="fas fa-fw fa-arrow-left"></i>
                        Lista de Órganos de Asesoria
                    </a>
                </li>
        ...
        <div class="container-fluid">
            <div class="card mt-4">
                <div class="card-header">
                    Editar Órgano de Asesoria
                </div>
                <div class="card-body">
                    {!! Form::model($subOrgano, ['route' => ['asesoria.update', $subOrgano->id], 'method' => 'PUT']) !!}
                        @csrf
                        @include('admin.organos_de_gobierno.apoyo_asesoria.asesoria.partials.form-editAsesoria')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
