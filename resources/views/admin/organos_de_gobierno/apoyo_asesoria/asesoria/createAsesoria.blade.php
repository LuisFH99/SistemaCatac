...
@section('title', 'Registrar Órgano de Asesoria')

@section('content_header')
    <h1>Registrar Órgano de Asesoria</h1>
@stop
        ...
        <div class="container-fluid">
            <div class="card mt-4">
                <div class="card-header">
                    Registrar Órgano de Asesoria
                </div>
                <div class="card-body">
                    {!! Form::open(['route' => 'asesoria.store','class'=>'needs-validation']) !!}
                        @csrf
                        @include('admin.organos_de_gobierno.apoyo_asesoria.asesoria.partials.form-createAsesoria')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
