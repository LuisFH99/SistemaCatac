            ...
            @if ($fromnoticia)
                <div class="modal-header">
                    <h5 class="font-weight-bold" id="exampleModalLabel">
                        {{ $noticia_id == 0 ? 'CREAR REGISTRO' : 'EDITAR REGISTRO' }}</h5>
                ...
                <div class="modal-footer">
                    <button type="button" wire:click="GuardarNoticia" class="btn btn-primary"><i
...
<script>
    function miNotificacion() {
        Livewire.on('alertaNoticia', function(datos) {
