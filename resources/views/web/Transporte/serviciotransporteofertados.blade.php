          ...
          <div class="sidebar sidebar-left">
            <div class="widget">
              ...
              <ul class="nav service-menu">
                ...
                <li class="active"><a href="/serviciosofertadostransporte">Productos</a></li>
        ...
        <div class="col-xl-9 col-lg-9 row row-cols-1 row-cols-sm-2 row-cols-md-2 g-3" style="text-align: justify">
          ...
          <div class="col">
            <div class="card shadow-sm mb-3 ">
              ...
              <div class="card-body">
                <p class="card-text card-title" style="width: 220px; white-space: nowrap; text-overflow: ellipsis  ;
