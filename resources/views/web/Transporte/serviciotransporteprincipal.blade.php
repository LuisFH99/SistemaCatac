          ...
          <div class="sidebar sidebar-left">
            <div class="widget">
              ...
              <ul class="nav service-menu">
                <li class="active"><a href="/serviciosprincipaltransporte">Detalles</a></li>
                <li><a href="/serviciosofertadostransporte">Servicios</a></li>
                <li><a href="/serviciosadquirirtransporte">Como adquirir el servicio</a></li>
                <li><a href="/serviciocontactotransporte">Contacto</a></li>
              </ul>
            </div><!-- Widget end -->
