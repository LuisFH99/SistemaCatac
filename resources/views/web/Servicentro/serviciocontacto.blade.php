          ...
          <div class="sidebar sidebar-left">
            <div class="widget">
              ...
              <ul class="nav service-menu">
                ...
                <li class="active"><a href="/serviciocontacto">Personal</a></li>
              </ul>
            </div><!-- Widget end -->
                ...
                <div class="row">
                  <div class="col-lg-7">
                    <div id="page-slider" class="page-slider small-bg">
                      <div class="item">
                        <center><img loading="lazy" class="img-fluid" src="{{$e->url_imagen}}" style="width: 450px; height: 330px;"/></center>
                      </div>
                    </div><!-- Page slider end -->
                  </div><!-- Slider col end -->
                  ...
                  <div class="col-lg-4 mt-5 mt-lg-0">          
                    <ul class="project-info list-unstyled">
                      ...
                      <li>
                        ...
                        <p class="project-info-content">Estación de servicio</p>
                      </li>
                    </ul>
